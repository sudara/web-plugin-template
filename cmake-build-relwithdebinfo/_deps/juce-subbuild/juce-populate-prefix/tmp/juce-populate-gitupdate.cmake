...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "7.0.5"
  WORKING_DIRECTORY "/Users/imagiro/Documents/audiodev/juce/templates/web-ui/cmake/cache/juce/f26b96ca62f3283d9503b994ae6b5a37ea611385"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("7.0.5" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/7.0.5")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/imagiro/Documents/audiodev/juce/templates/web-ui/cmake/cache/juce/f26b96ca62f3283d9503b994ae6b5a37ea611385'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/imagiro/Documents/audiodev/juce/templates/web-ui/cmake/cache/juce/f26b96ca62f3283d9503b994ae6b5a37ea611385'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
